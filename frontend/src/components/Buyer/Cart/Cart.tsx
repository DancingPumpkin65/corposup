...
const Cart = () => {
	...
	const handleRemove = (id: number) => {
		// Remove logic here (API call or state update)
	};
												...
												<TableRow key={prod.id}>
													...
													<TableCell className="text-left justify-center items-center">
														<DropdownMenu>
                                                            ...
                                                            <DropdownMenuItem className="text-gray-600 focus:text-gray-600 cursor-pointer hover:bg-blue-50 fill-gray-500" onClick={() => onEdit?.(d)}>

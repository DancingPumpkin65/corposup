    ...
    <SidebarInset>
      <header className="flex w-full h-16 shrink-0 items-center gap-2 border-b px-4 bg-white">
        ...
        <div className="flex items-center gap-2">
          <h1 className="text-lg font-semibold">Produits sauvegardés</h1>
        </div>
      </header>
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <h2 className="text-3xl font-bold mb-4">Vos produits sauvegardés</h2>
              <p className="text-gray-600">Aucun produit sauvegardé pour l’instant.</p>
            </div>
          )}
        </div>
      </div>

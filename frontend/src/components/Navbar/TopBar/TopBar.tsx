        ...
        <div className="flex w-full justify-between items-center py-2">
          <div className="flex flex-row items-center text-white text-xs sm:text-sm space-x-2 sm:space-x-4">
            <div className="hidden sm:flex items-center">
              ...
              <span className="text-[11px] leading-none font-medium tracking-wider">+212 661 368 103</span>
            </div>

            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="hidden w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-[12px] leading-none font-medium tracking-wider">contact@corposup.com</span>
            </div>
          </div>
